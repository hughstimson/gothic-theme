<?php
/*
Template Name: projects - radio
*/
?>
<?php get_header(); ?>
<div class="row">
	<div class="side-bar">
			<h1 class="back-link"><a href="<?php bloginfo('url'); ?>/projects"><span class="nav-arrow">&larr;</span> back to projects</a></h1>
	</div><!--side-bar-->
	<?php
	query_posts('post_type=page&meta_key=topic&meta_value=radio'); 
